...
- [x] [Max Min Values in k bits](Definitions/V01/Max%20Min%20Values%20in%20k%20bits.md)
- [x] Powers of Two
- [x] Decimal -> Binary Conversion
	- [ ] Repeated Division
	- [ ] Repeated Subtraction
- [x] [2-Complement Notation](Definitions/V01/2-Complement%20Notation.md)
- [x] [Sign Extension](Definitions/V01/Sign%20Extension.md)
- [ ] *Practice Questions*
...
- [x] [Hexadecimal to Decimal](Definitions/V02/Hexadecimal%20to%20Decimal.md)
- [x] Endianness
#### LEC 3: [V03-ComputerOrganizationMemoryAddressing.pdf](PDF%20Notes/V03-ComputerOrganizationMemoryAddressing.pdf)
- [x] [Organization of a Computer](Definitions/V03/Organization%20of%20a%20Computer.md)
- [x] [Arithmetic Operations](Definitions/V03/Arithmetic%20Operations.md)
- [x]  C Code -> Assembly (Basic arithmetic operations)
	- A[0] = h + A[2], h <-> s2, A <-> s1
		- lw t0, 8(s1)
		- add t0, s2, t0
		- sw t0, 0(s1)
...
- [x] [Data Transfer](Definitions/V04/Data%20Transfer.md)
#### LEC 5: [V05-InstructionRepresentation.pdf](PDF%20Notes/V05-InstructionRepresentation.pdf)
- [x] [If else statement](Definitions/V05/If%20else%20statement.md)
- [x] Representing Instructions
	- [x] [Parts of an instruction](Definitions/V05/Parts%20of%20an%20instruction.md)
	- [x] [Types of Instructions](Definitions/V05/Types%20of%20Instructions.md)
	- [x] Instructions <-> Hexadecimal Representation
- [x] [Unconditional Jumps](Definitions/V05/Unconditional%20Jumps.md)
- [x] The Constant Zero
- [ ] *Practice Questions*:
...
- [x] [Logic Operations](Definitions/V06/Logic%20Operations.md)
- [x] [Binary to Decimal](Definitions/V06/Binary%20to%20Decimal.md) 
- [x] [Bitwise Logical Operations](Definitions/V06/Bitwise%20Logical%20Operations.md)
	- [x] [RARS issue](Definitions/V06/RARS%20issue.md)
- [x] Load Immediate Instruction  (li)
- [ ] *Practice Questions*
...
- [x] [Large Constants](Definitions/V07/Large%20Constants.md)
- [x] Handling Large Constants in RARS
	- [x] Pseudocode
- [ ] *Practice Questions*
...
- [x] Conditional Operations 
	- [x] [While Loops](Definitions/V09/While%20Loops.md)
- [x] [Comparison](Definitions/V09/Comparison.md) 
- [x] [Signed vs Unsigned Comparison](Definitions/V09/Signed%20vs%20Unsigned%20Comparison.md)
- [x] Basic Blocks
#### LEC 10: [V0A-IsBraExample.pdf](PDF%20Notes/V0A-IsBraExample.pdf)
- [x] [Load Address](Definitions/V0A/Load%20Address.md) 
- [ ] IsBra Sample question
#### LEC 11: [V0B-ProcedureCallsAndStack.pdf](PDF%20Notes/V0B-ProcedureCallsAndStack.pdf)
- [x] [Callable Units](Definitions/V0B/Callable%20Units.md)
- [x] Procedure Calls
	- [x] Finding Return Address
		- [ ] Store Return address before calling
	- [x] Problem
		- [ ] Single ra register
- [x] [Call Stacks](Definitions/V0B/Call%20Stacks.md)
- [x] [Stack Pointer](Definitions/V0B/Stack%20Pointer.md)
- [x] Memory Layout
#### LEC 12: [V0C-RegisterCallingConvention.pdf](PDF%20Notes/V0C-RegisterCallingConvention.pdf)
- [x] Register saving/restoring calling conventions
- [x] [Register Usage Conventions](Definitions/V0C/Register%20Usage%20Conventions.md)
- [x] [Function Execution](Definitions/V0C/Function%20Execution.md)
- [x] [Frame pointer](Definitions/V0C/Frame%20Pointer.md)
...
- [x] Recursive functions
	- [x] [Non-Leaf Procedures](Definitions/V0D/Non-Leaf%20Procedures.md)
...
- [x] Instructions to Manipulate Characters
- [x] Instructions to Manipulate Half Words
- [x] Array Indexing
	- [x] Integers
	- [x] Characters
	- [x] Doubles
	- [x] Structures
		- [x] Issues with structs (Data Alignment)
- [ ] String Copy (strcpy)
- [x] [Unconditional Jumps](Definitions/V05/Unconditional%20Jumps.md)
- [ ] *Practice Questions*
...
- [x] [Relative Performance](Definitions/V0F/Relative%20Performance.md)
- [x] [Latency](Definitions/V0F/Latency.md)
- [x] [Throughput](Definitions/V0F/Throughput.md)
- [ ] Measuring Time
#### LEC 17: [V10-ClockAndFrequency.pdf](PDF%20Notes/V10-ClockAndFrequency.pdf)
- [x] [CPU Clocking Formulas](Definitions/V10/CPU%20Clocking%20Formulas.md)
#### LEC 18: [V11-CPI.pdf](PDF%20Notes/V11-CPI.pdf)
- [x] CPI (Clock Per Instruction)
- [ ] *Practice Questions*
	- 48. CPI
...
- [x] Cost/ Performance improvement
	- [x] Power as a limiting factor
- [x] Hierarchal layers of abstraction
- [x] [Amdahl's Law](Definitions/V12/Amdahl's%20Law.md)
- [ ] *Practice Questions*
	- [ ] 46. CPI, Ahmdal's Law
...
- [x] Register Calling Conventions
- [x] Data Flow  
#### LEC 22: [V15-IndexingVsPointers.pdf](PDF%20Notes/V15-IndexingVsPointers.pdf)
- [x] [[Array Index vs Pointers]](Definitions/V15/Array%20Index%20vs%Pointers.md)
	- [x] CPI vs actual performance
- [ ] *Practice Questions*
	- 37. Pointers
